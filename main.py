...
def validate_pricing_data(pricing_data):
    ...
    # If pricing_tiers exists, ensure it's an array
    if "pricing_tiers" in pricing_data and not isinstance(pricing_data["pricing_tiers"], list):
        print("Validation failed: pricing_tiers must be a list")
        return False
    
    # If usage_based_pricing exists, ensure it's an array
    if "usage_based_pricing" in pricing_data and not isinstance(pricing_data["usage_based_pricing"], list):
